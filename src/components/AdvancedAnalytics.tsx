    ...
    >
      <div className="p-5 space-y-8">
        ...
        <div>
          ...
          {hasPeriod ? (
              ...
              <div className="overflow-x-auto border border-pwhl-border max-h-[32rem] overflow-y-auto rounded-lg shadow-sm">
                <table className="w-full text-left font-serif text-sm">
                  <tbody className="bg-white">
                    {groupedPeriodRows(period, data?.team_name ?? 'Team').map((group) => (
                      <React.Fragment key={group.period}>
                        <tr>
                          <td className="px-4 py-2 font-bold text-torrent-teal border-y border-pwhl-border bg-pwhl-surface/50 font-serif text-base">
                            {group.period}
                          </td>
            ...
            <p className="text-sm text-pwhl-muted">
              No period recap rows available in this hub export.
            </p>
          )}
        </div>
        ...
        <div className="space-y-4">
          ...
          {!hasSeq ? (
            <p className="text-sm text-pwhl-muted">No sequence rows available in this hub export.</p>
          ) : (
            <>
